  ...
  return (
    <header className="w-full bg-[#0F1A26] sticky top-0 z-50">
      <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm" style={{ color: "#9BA8B5" }}>
      ...
      {open && (
        <div className="md:hidden border-t border-white/10 px-6 py-5 flex flex-col gap-4 text-sm bg-[#0F1A26]" style={{ color: "#9BA8B5" }}>
