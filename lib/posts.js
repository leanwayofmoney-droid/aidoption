export const posts = [
  {
    ...
    curiosityHeader: "Mailbox op dieet",
    ...
    nuance: `Deze fix werkt niet voor gevoelige of juridische correspondentie. Vertrouwelijke informatie plak je niet zomaar in een extern systeem. Gebruik het voor de dagelijkse stroom van werkmail. Niet voor contractonderhandelingen of persoonlijke gesprekken. Bij twijfel: kies voor voorzichtigheid.`,
...
[PLAK HIER JE E-MAILS]`,
  ...
  },
  {
    ...
    curiosityHeader: "Weekmenu zonder nadenken",
...
3. Voor elk gerecht: een korte bereidingsstap`,
  ...
  },
  {
    ...
    curiosityHeader: "Vergaderen voor doeners",
...
[PLAK HIER JE AANTEKENINGEN]`,
  ...
  },
  {
    ...
    curiosityHeader: "Solliciteren zonder blanco pagina",

    persoonlijkeMissie: `Ik herinner me het gevoel nog goed. Blanco pagina. Interessante vacature. Hoe begin je? Niet met 'hierbij solliciteer ik'. Dat weet ik. Maar wat dan? Een uur later had ik drie alinea's die nergens op sloegen. **Sollicitatiebrieven schrijven is een vak apart.** Het merendeel van ons heeft dat vak nooit geleerd. Ik ook niet.`,
...
[SCHRIJF HIER 5-10 ZINNEN OVER JE ERVARING EN MOTIVATIE]`,
  ...
  },
  {
    ...
    curiosityHeader: "Trainen voor nul euro",
    ...
    transformatie: `**De oude manier:** willekeurig sporten zonder structuur of progressie. Af en toe googelen op schema's die nooit precies pasten.\n\n**Met de AI-Fix:** ik beschrijf mijn doel, niveau en beschikbare tijd. Binnen een minuut heb ik een schema. Met oefeningen, sets, herhalingen en een progressieplan voor vier weken.`,

    strategischeLogica: `Een goed trainingsschema is eigenlijk een algoritme. **Het houdt rekening met input, verwerkt die naar output en past zich aan op basis van progressie.**\n\nIk instrueer de AI om te denken als een fysiotherapeut met sportersachtergrond. Niet alleen 'doe tien push-ups'. Maar waarom, in welke verhouding tot andere oefeningen en hoe je dat opbouwt. Door blessures en beperkingen expliciet mee te geven dwing ik de machine om er creatief omheen te werken.\n\n**De slimste instructie is progressie.** De meeste gratis schema's zijn statisch. Ik laat de AI een schema maken dat na vier weken klaar is voor een zwaarder vervolg. Dezelfde oefeningen. Maar met tien procent meer volume. Zo bouw je systematisch op.\n\nWat het persoonlijk maakt is de context. Thuis met dumbbells en vijfenveertig minuten per sessie geeft een compleet ander schema dan een volledig ingerichte sportschool. **De AI optimaliseert binnen jouw grenzen.** Dat is precies wat een goede trainer ook doet.`,
